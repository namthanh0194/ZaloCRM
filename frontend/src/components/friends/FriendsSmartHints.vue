...
.hint-chip {
  ...
  background: var(--color-warning-subtle); color: #78350f;
...
.hint-chip.success { background: var(--color-success-subtle); color: #166534; border-color: #4ade80; }
.hint-chip.success:hover { background: #bbf7d0; }
.hint-chip.danger { background: var(--color-danger-subtle); color: #991b1b; border-color: #f87171; }
