...
.shm-head {
  ...
  border-bottom: 1px solid var(--color-bg, #eef0f4);
}
.shm-title {
  font-size: 15px;
  font-weight: 700;
...
.shm-close:hover { background: var(--color-bg, #eef0f4); color: var(--color-text-secondary, #3d4456); }
...
.shm-pill:hover { background: var(--color-border, #e1e4eb); }
.shm-pill.active {
  background: var(--color-primary-subtle, #e8efff);
...
.shm-row:hover { background: var(--color-surface-secondary, #f8f9fb); }
...
.shm-footer {
  padding: 12px 18px;
  border-top: 1px solid var(--color-bg, #eef0f4);
  display: flex;
  justify-content: flex-end;
}
.shm-btn-secondary {
  padding: 8px 16px;
  border: 1px solid var(--color-border, #e1e4eb);
  background: white;
  border-radius: 6px;
  cursor: pointer;
  font-size: 13px;
...
.shm-btn-secondary:hover { background: var(--color-surface-secondary, #f8f9fb); }
</style>
