...
/**
 * Canonical Repu Digital themes. Semantic CSS tokens are synchronized by
 * useAppTheme so Vuetify and custom components always use the same mode.
 */
    ...
    themes: {
      ...
      'repuDark': {
        ...
        colors: {
          background: '#0f1722',
          surface: '#152131',
          'surface-variant': '#1b2a3d',
          primary: '#5bb8e5',
          'primary-darken-1': '#1786be',
          secondary: '#d5deea',
          accent: '#7bc6ea',
          error: '#fb7185',
          warning: '#fbbf24',
